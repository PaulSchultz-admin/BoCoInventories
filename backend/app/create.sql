...
-- Editable site content (About/Resources/Contact bodies and glossary terms).
-- Lives per-dataset, same as everything else in this schema, so butterflies/
-- dragonflies/wildflowers each have their own independently-editable copy.
